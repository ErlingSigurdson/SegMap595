...
#define SEGMAP595_MAP_ALPHABETICAL_H          0b00010111
#define SEGMAP595_MAP_ALPHABETICAL_I          0b00010000
#define SEGMAP595_MAP_ALPHABETICAL_J          0b00111100
#define SEGMAP595_MAP_ALPHABETICAL_K          0b01010111
#define SEGMAP595_MAP_ALPHABETICAL_L          0b00001110
#define SEGMAP595_MAP_ALPHABETICAL_M          0b01010101
...
#define SEGMAP595_MAP_ALPHABETICAL_V          0b00011100
#define SEGMAP595_MAP_ALPHABETICAL_W          0b00101011
#define SEGMAP595_MAP_ALPHABETICAL_X          0b00110111
...
#define SEGMAP595_MAP_ALPHABETICAL_EQUAL      0b00001001
#define SEGMAP595_MAP_ALPHABETICAL_DEGREE     0b01100011
...
#define SEGMAP595_MAP_ALPHABETICAL_ALL SEGMAP595_MAP_ALPHABETICAL_0,      \
                                       ...
                                       SEGMAP595_MAP_ALPHABETICAL_V,      \
                                       SEGMAP595_MAP_ALPHABETICAL_W,      \
                                       SEGMAP595_MAP_ALPHABETICAL_X,      \
                                       SEGMAP595_MAP_ALPHABETICAL_Y,      \
                                       SEGMAP595_MAP_ALPHABETICAL_Z,      \
                                       SEGMAP595_MAP_ALPHABETICAL_DASH,   \
                                       SEGMAP595_MAP_ALPHABETICAL_EQUAL,  \
                                       SEGMAP595_MAP_ALPHABETICAL_DEGREE, \
...
#define SEGMAP595_INDEX_M          22
#define SEGMAP595_INDEX_N          23
#define SEGMAP595_INDEX_O          24
#define SEGMAP595_INDEX_P          25
#define SEGMAP595_INDEX_Q          26
#define SEGMAP595_INDEX_R          27
#define SEGMAP595_INDEX_S          28
#define SEGMAP595_INDEX_T          29
#define SEGMAP595_INDEX_U          30
#define SEGMAP595_INDEX_V          31
#define SEGMAP595_INDEX_W          32
#define SEGMAP595_INDEX_X          33
#define SEGMAP595_INDEX_Y          34
#define SEGMAP595_INDEX_Z          35
#define SEGMAP595_INDEX_DASH       36
#define SEGMAP595_INDEX_EQUAL      37
#define SEGMAP595_INDEX_DEGREE     38
#define SEGMAP595_INDEX_UNDERSCORE 39

/* Some resulting symbols resemble their actual prototypes,
...
#define SEGMAP595_CHAR_A          'A'  // Like actual 'A'.
#define SEGMAP595_CHAR_B          'B'  // Like actual 'b'.
#define SEGMAP595_CHAR_C          'C'  // Like actual 'C'.
#define SEGMAP595_CHAR_D          'D'  // Like actual 'd'.
#define SEGMAP595_CHAR_E          'E'  // Like actual 'E'.
#define SEGMAP595_CHAR_F          'F'  // Like actual 'F'.
#define SEGMAP595_CHAR_G          'G'  // Like actual 'G', but without the short horizontal stroke.
#define SEGMAP595_CHAR_H          'H'  // Like actual 'h'.
#define SEGMAP595_CHAR_I          'I'  // Short vertical stroke, not equivalent to '1'.
#define SEGMAP595_CHAR_J          'J'  // More or less like actual 'J'.
#define SEGMAP595_CHAR_K          'K'  // Barely resembles actual 'K'.
#define SEGMAP595_CHAR_L          'L'  // Like actual 'L'.
#define SEGMAP595_CHAR_M          'M'  // Like actual 'n' with a dash over it.
#define SEGMAP595_CHAR_N          'N'  // Like actual 'n'.
#define SEGMAP595_CHAR_O          'O'  // Like actual 'o' (to distinguish from zero).
#define SEGMAP595_CHAR_P          'P'  // Like actual 'P'.
#define SEGMAP595_CHAR_Q          'Q'  // More or less like actual 'q'.
#define SEGMAP595_CHAR_R          'R'  // Like actual 'r'.
#define SEGMAP595_CHAR_S          'S'  // More or less like actual 'S', equivalent to '5'.
#define SEGMAP595_CHAR_T          'T'  // More or less like actual 't'.
#define SEGMAP595_CHAR_U          'U'  // Like actual 'U'.
#define SEGMAP595_CHAR_V          'V'  // Like actual 'u'.
#define SEGMAP595_CHAR_W          'W'  // Like elevated actual 'u' with a dash under it.
#define SEGMAP595_CHAR_X          'X'  /* Like actual 'H', because keeping it like this gives up space
                                        * for 'H' byte that looks like actual 'h'.
                                        */
#define SEGMAP595_CHAR_Y          'Y'  // More or less like Cyrillic 'У'.
#define SEGMAP595_CHAR_Z          'Z'  // Equivalent to '2'.
#define SEGMAP595_CHAR_DASH       '-'
#define SEGMAP595_CHAR_EQUAL      '='
#define SEGMAP595_CHAR_DEGREE     '*'
...
#define SEGMAP595_CHAR_ALL SEGMAP595_CHAR_0,      \
                           ...
                           SEGMAP595_CHAR_Z,      \
                           SEGMAP595_CHAR_DASH,   \
                           SEGMAP595_CHAR_EQUAL,  \
                           SEGMAP595_CHAR_DEGREE, \
