 ...
 * ----------------------------------------------------------------------------|---------------------------------------|
 * Purpose:  Specific macros/constants related to mapping and glyphs.
 * ----------------------------------------------------------------------------|---------------------------------------|
...
#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_G          0b01011110  /* Like actual 'G', but without
                                                                            * the short horizontal stroke.
                                                                            */

#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_H          0b00010111  // Like actual 'h'.

#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_I          0b00010000  /* Short vertical stroke,
                                                                            * not equivalent to '1'.
                                                                            */

#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_J          0b00111100  // More or less like actual 'J'.
...
#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_Q          0b01110011  // More or less like actual 'q'.
#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_R          0b00000101  // Like actual 'r'.

#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_S          0b01011011  /* More or less like actual 'S',
                                                                            * equivalent to '5'.
                                                                            */
...
#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_W          0b00101011  /* Like elevated actual 'u'
                                                                            * with a dash under it.
                                                                            */
...
#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_Y          0b00111011  // More or less like Cyrillic 'У'.

#define SEGMAP595_GLYPH_SET_1_MAPPED_ALPHABETICALLY_Z          0b01101101  /* More or less like actual 'Z',
                                                                            * equivalent to '2'.
                                                                            */
...
#define SEGMAP595_GLYPH_SET_1_CHAR_DEGREE     '*'  // Special case, because there's no ASCII for degree symbol.
