...
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_A 0b01110111  // Like the actual 'A'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_B 0b00011111  // Like the actual 'b'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_C 0b01001110  // Like the actual 'C'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_D 0b00111101  // Like the actual 'd'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_E 0b01001111  // Like the actual 'E'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_F 0b01000111  // Like the actual 'F'.

#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_G 0b01011110  /* More or less like the actual 'G',
                                                      * but without the short horizontal stroke.
                                                      */

#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_H 0b00010111  // Like the actual 'h'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_I 0b00010000  // Short vertical stroke, not equivalent to '1'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_J 0b00111100  // Like the actual 'J'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_K 0b01010111  // Barely resembles the actual 'K'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_L 0b00001110  // Like the actual 'L'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_M 0b01010101  // Like the actual 'n' with a dash over it.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_N 0b00010101  // Like the actual 'n'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_O 0b00011101  // Like the actual 'o' (to distinguish from zero).
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_P 0b01100111  // Like the actual 'P'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_Q 0b01110011  // Like the actual 'q'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_R 0b00000101  // Like the actual 'r'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_S 0b01011011  // Like the actual 'S', equivalent to '5'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_T 0b00001111  // More or less like the actual 't'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_U 0b00111110  // Like the actual 'U'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_V 0b00011100  // Like the actual 'u'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_W 0b00101011  // Like elevated actual 'u' with a dash under it.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_X 0b00110111  // Like the actual 'H'.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_Y 0b00111011  // Like the actual 'y', but the size of a capital letter.
#define SEGMAP595_GLYPH_SET_1_ABC_BYTE_Z 0b01101101  // More or less like the actual 'Z', equivalent to '2'.
...
#define SEGMAP595_GLYPH_SET_1_CHAR_DEGREE     '*'  // Special case: there's no ASCII character for the degree symbol.
